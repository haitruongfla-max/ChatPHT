...
describe("Cấu hình APK nền OTA", () => {
  ...
  it("tăng versionCode cho APK P2P 1:1 1.0.18 và khai báo MediaProjection Android", () => {
    expect(configSource).toContain('version: "1.0.18"');
    expect(configSource).toContain("versionCode: 22");
