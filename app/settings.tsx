...
import { areChatPushNotificationsEnabled, clearStoredPushToken, getStoredPushToken, registerForChatPushNotifications, setChatPushNotificationsEnabled, storePushToken } from "@/lib/push-notifications";
  ...
  return (
    <ScreenContainer edges={["top", "bottom", "left", "right"]}>
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.section}><Text style={styles.sectionTitle}>Thông báo</Text><View style={styles.card}><View style={styles.row}><View style={styles.icon}><MaterialIcons name="notifications-none" size={21} color="#1D4ED8" /></View><View style={styles.rowBody}><Text style={styles.rowTitle}>Hiển thị thông báo</Text><Text style={styles.rowText}>Báo tin nhắn mới mà không hiển thị nội dung riêng tư.</Text></View><Switch value={pushEnabled} disabled={loading || savingPush} onValueChange={(value) => void changePushEnabled(value)} trackColor={{ false: "#CBD5E1", true: "#93C5FD" }} thumbColor={pushEnabled ? "#2563EB" : "#F8FAFC"} /></View></View></View>
