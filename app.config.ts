...
const releaseId = "CPHT-1.0.46-vc50-native-webrtc-adapter-fix";
...
const config: ExpoConfig = {
  ...
  plugins: [
    "expo-router",
    "./src/features/webrtc-calling/config/withAndroidMediaProjection.js",
    "./src/features/webrtc-calling/config/withAndroidIncomingCall.js",
    "expo-asset",
    "expo-font",
    "expo-web-browser",
    [
